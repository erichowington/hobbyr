...
const navOptions = (
  ...
  <div className='nav-icons'>
    <NavLink className='nav-link' to='/'><img className='nav-icon' src='https://github.com/erichowington/hobbyr/blob/dev/public/images/hobbyr-icons/home-icon.png?raw=true'/></NavLink>
    ...
    <NavLink className='nav-link' to={`/profile/${profile.id}`}><img className='nav-icon'src='https://github.com/erichowington/hobbyr/blob/dev/public/images/hobbyr-icons/profile-icon.png?raw=true'/></NavLink>
