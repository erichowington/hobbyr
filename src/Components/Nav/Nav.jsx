...
const navOptions = (
  ...
  <div className='nav-icons'>
    <NavLink className='nav-link' to='/'><img className='nav-icon' src='https://github.com/erichowington/hobbyr/blob/dev/public/images/hobbyr-icons/home-icon.png?raw=true'alt="logo"/></NavLink>
